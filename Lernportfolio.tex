...
\begin{section}{Motorensteuerung}
  ...
  Durch die Datenblätter \gquotes{PCA9685 PWM driver} und \gquotes{TB6612 Motor
    driver} wurde die Funktionsweise des \referenzcode's
...
\begin{section}{Kompass}
  ...
  keine neuen Daten einlesen, da die alten Daten noch aktuell sind.
  ...
  %%% und wir wissen schneller ob nicht etwas beim Setup fehlgeschlagen ist.
  Falls die Daten aktualisiert worden sind, gibt die Methode eine eins zurück. Ansonsten eine 0. 

  Nachdem wir nun die ersten Register gelesen hatten und wusste das der Kompass funktioniert, mussten wir nun die Daten 
