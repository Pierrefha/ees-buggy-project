...
\begin{section}{Zusammenfassung}
  ...
  Es gab auch ein paar Sachen die leichter fielen als erwartet. So z.B. das
      ...
      %Unser Projekt war ein mini Projekt %Größeres Projekt in Hinsicht auf die bisherigen Verhältnisse
      mittlerweile recht selbstverständlich ist, besonders bei größeren Projekten im Vergleich zu den 
	    bisherigen Praktika, hat sehr geholfen. Man konnte den Code der Gruppenmitglieder schnell 
  	  selber einsehen und sich so gegenseitig helfen und austauschen.
  \end{subsection}
        \begin{subsection}{Zusammenfassung Pierre Dahmani}
            ...
            zu sein. Bei einzelnen Messungen kann eine hohe Varianz entstehen, welche
            ...
            bewiesen. Dies haben wir über GitHub anhand von Pull-Requests durchgeführt.
            % End task 5.1
            \end{paragraphwithnewline}
            ...
            Das Verwenden von Git als VCS war eine gute Wahl, weil jeder der
            Teammitglieder bereits vertraut damit war. Das wählen von \LaTeX\
            ...
            \begin{paragraphwithnewline}{Das hat Spaß bereitet}
            Am meisten Spaß hat es mir gemacht den implementierten Code dann am Buggy zu
            ...
            habe ich ein besseres Verständnis dafür bekommen, wie man Treiber
            programmiert und diese schließlich verwendet. Ich haben erstaunlich
            viel Spaß daran gehabt und werde mich in meiner Freizeit nun vermehrt
