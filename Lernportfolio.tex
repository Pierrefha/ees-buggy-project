...
\begin{section}{Kompass}
  ...
  Im Datenblatt stößt man als erstes auf die I2C Adresse des Kompass, mit der man dann z.B. mit dem Befehl 
  "i2cdetect -y 1" überprüfen, ob der Kompass richting angeschlossen ist. Die Adresse des Kompass ist "0x0D" 
  und wurde in der Tabelle der i2c Geräte angezeigt.
  ...
  Jetzt kann man sehen das die Werte bereits eine Ellipse anzeigen aber noch keinen guten Kreis darstellen, mit dem 
  man eine, zumindest relative, Gradrichtung bestimmen kann. Mit der Hilfe eines Forumbeitrags im Ilias einer 
  anderen Gruppe bezüglich der Kalibrierung konnte wir nur die Daten dazu benutzten, um auch unseren Kompass jetzt 
  anzupassen.
